...
- z The mounting of four devices on an ultra-compact package allows the number of parts and the mounting cost to be reduced. z Low terminal capacitance: CT = 8.0 pF (typ.)
...
|-----------------------------------------------------|--------|--------------------|-----|------|-----|------|
| Zener voltage                                       | VZ     | IZ = 5 mA          | 5.3 | 5.6  | 6.0 | V    |
| Dynamic impedance                                   | ZZ     | IZ = 5 mA          | ―   | ―    | 50  | Ω    |
| Reverse current                                     | IR     | VR = 3.5 V         | ―   | ―    | 1.0 | μA   |
| Terminal capacitance<br>(between Cathode and Anode) | CT     | VR = 0V, f = 1 MHz | ―   | 8    | ―   | pF   |

#### **Guaranteed Level of ESD Immunity**

| Test Condition                      | ESD Immunity Level |
|-------------------------------------|--------------------|
| IEC61000-4-2<br>(Contact discharge) | ± 8 kV             |
